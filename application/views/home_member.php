	...
	<title>Fuchsia Skin Clinic Center - Klinik Kecantikan Pusat Perawatan Wajah dan Kulit - Website</title>
	...
	<body id="home">
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-10 visible-desktop">
						...
						<a class="navbar-brand" href="<?php echo site_url('home/home_member');?>">
						...
						<a class="navbar-brand" href="<?php echo site_url('Login/logout');?>">
							...
							<li style="padding:31px 15px 4px 6px;">
							<a href="<?php echo site_url('home/treatment_member');?>">TREATMENT</a></li>
							<li style="padding:31px 15px 4px 6px;">
							<a href="<?php echo site_url('home/product_member');?>">PRODUCT</a></li>
							<li style="padding:31px 15px 4px 6px;">
		...
		<div class="navbar hidden-desktop">
			<div class="navbar-inner" style="background:#E02187;">
				<div class="container" align="center">
					<a href="#%21" class="pull-left" id="toggle-sidebar" style="margin:10px;">
						<i class="fa fa-align-justify fa-2x"></i>
					</a>
					<a href="http://www.natasha-skin.com/">
						<img src="<?php echo base_url('natasha_files/img_jagKKrJ.jpg');?>" alt="Fuchsia Skin Clinic Center" height="40px">
					</a>
					<div class="nav-collapse collapse">
						<ul>
							<li><a href="<?php echo site_url('home/about');?>">About Us</a></li>
							<li><a href="<?php echo site_url('home/treatment_member');?>">Treatment</a></li>
							<li><a href="<?php echo site_url('home/product_member');?>">Product</a></li>
	...
	<div data-simplersidebar="disabled" style="position: fixed; top: 0px; bottom: 0px; width: 300px; left: -300px; z-index: 3000;" id="sidenav" class="sidenav sidenav-left">
		<div class="sidenav-wrapper">
			<header class="sidenav-header">
				<img src="<?php echo base_url('natasha_files/img_jagKKrJ.jpg');?>" alt="Fuchsia Skin Clinic Center" height="60px">
			</header>
			...
			<footer>
				Powered By <a href="http://RajaPutri.co.id/">RajaPutriAnnisa</a>
			</footer>
		</div>
	</div>		<!-- Content -->
			<div class="content">
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-12">
						...
						<img src="<?php echo base_url('natasha_files/homee.jpg');?>" class="img-responsive" alt="Fuchsia Skin Clinic Center">
					</div>
						<div class="col-sm-12" style="margin-top:20px">
						<div style="text-align: justify;"> <span style="font-weight: bold;">SELAMAT DATANG DI FUCHSIA SKIN CLINIC</span>
						<p style="margin-top:10px;text-align:justify">Pusat perawatan kecantikan kulit yang memadukan teknologi terkini dalam perawatan kulit dan 
						tenaga profesional yang siap membantu Anda wujudkan impian kulit sehat dan terawat.</p>
			</div>
					</div>
			</div>            	
		</div>
		<div class="wrapper news-letters message" style="margin-top:30px">
		<div class="container">
			<div class="row">
			   <div class="col-sm-7">
					<h3>SUBSCRIBE OUR NEWSLETTER</h3>
					<h4>Subscribe to our e-mail newsletter and take advantage of the promotions.</h4>
				</div>
				<div class="col-sm-5">
					<div class="input">
						<form class="form-inline" method="post" action="http://www.natasha-skin.com/subscribe">
						  <input id="email" name="email" placeholder="Enter your email here" required="" type="email">
