	...
	<body id="home">
      ...
      <div class="row">
        ...
        <div class="col-lg-8 mb-4">
          <!-- Embedded Google Map -->
             <iframe src="https://www.google.com/maps/place/Mutiara+Asri+Garden/@0.4780935,101.4298951,15z/data=!4m2!3m1!1s0x0:0x2627ee25738053be?sa=X&ved=0ahUKEwiwk67tnMrXAhUEpo8KHRIqAikQ_BIIXDAF" width="100%" height="400px" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" allowfullscreen></iframe>
        </div>
        <!-- Contact Details Column -->
        <div class="col-lg-4 mb-4">
          <h3>Contact Details</h3>
          <p>
              Ruko Mutiara Asri Garden
              <br> Jl. Arifin Ahmad no.7
              <br> Sidomulyo Tim., Marpoyan Damai, Kota Pekanbaru,
            <br>Riau, 28289
            <br>
          </p>
          <p>
            <abbr title="Phone">Phone, WhatsApp </abbr>: 082385543030
          </p>
          <p>
            <abbr title="Facebook">Facebook</abbr>:
            <a href="www.facebook.com">Fuchsia Skin Clinik
            </a>
          </p>
          <p>
            <abbr title="Buka">Buka</abbr>:Pukul 9:00-17:00
          </p>
