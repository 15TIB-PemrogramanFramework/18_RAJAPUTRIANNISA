						...
						<form class="form" method="post" action="<?php echo site_url('member/daftar_aksi')?>">
							...
							<div class="content">
								...
								<div class="input-group">
									...
									<input type="text" class="form-control" placeholder="Nama..." name="nama_member">
								</div>
								...
								<div class="input-group">
									...
									<input type="email" class="form-control" placeholder="Email..." name="email_member">
								</div>
								...
								<div class="input-group">
									...
									<input type="text" placeholder="Alamat..." class="form-control" name="alamat_member" />
								</div>
